...
void LocalScope::AddDevice(std::string_view device_class, Device *device) {
...
Device *LocalScope::raw_device(std::string_view name) const {
...
Device *LocalScope::raw_device(int ordinal) const {
