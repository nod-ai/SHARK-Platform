...
@embedding_lookup.override(input=Tensor, embedding_matrix=Tensor)
...
@embedding_lookup.override(input=Tensor, embedding_matrix=PrimitiveTensor)
...
@embedding_lookup.override(input=Tensor, embedding_matrix=QuantizedTensor)
...
@rms_norm.override(x=Tensor, weight=Tensor)
...
@rms_norm.override(x=Tensor, weight=PrimitiveTensor)
...
@rms_norm.override(x=Tensor, weight=QuantizedTensor)
