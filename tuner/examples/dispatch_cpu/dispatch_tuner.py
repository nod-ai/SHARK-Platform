...
python -m examples.dispatch_cpu benchmark.mlir --lhs-dims=bmk --rhs-dims=bkn --tile-dims=*mnk --devices=local-task:// --num-candidates=64


Recommended Trial Run:

python -m examples.dispatch_cpu benchmark.mlir --num-candidates=10


Dry Run Test (no gpu required):

python -m examples.dispatch_cpu benchmark.mlir --num-candidates=64 --dry-run
